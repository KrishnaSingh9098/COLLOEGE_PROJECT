      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          ...
          >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="Punjab National BankL">
                      Punjab National Bank
                    </option>
                    <option value="Union BAnk Of Indi">
                      Union BAnk Of India
                    </option>
                    <option value="Allahabaad Bank">Allahabaad Bank</option>
                  </select>
                  <input
                    type="text"
            ...
            <button
              className="bg-[#d6482b] w-full sm:w-[420px] lg:w-[640px] font-semibold hover:bg-[#b8381e] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white mx-auto my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
